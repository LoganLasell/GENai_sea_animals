...
## Limitations
#### The first limitation I ran into was that the epoch length was nowhere near the length needed for accurate sea animal image replication. And my current hardware limited the speed of training for my GAN. 
